...
export async function getActivityStats() {
    // Today stats from REAL tables, not empty activity_log
...
export async function getSmartInsights() {
    // Users with no recent session (or never logged in) — real data from session_log
    ...
    // Recent activity mix (from session_log + reports + feedback)

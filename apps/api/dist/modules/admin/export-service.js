...
export async function exportReports() {
    const rows = await db.all(`SELECT r.id, u.name as student_name, r.experiment_name, c.name as class_name, t.name as teacher_name, r.status, r.grade, r.submitted_at, r.graded_at
...
export async function exportClasses() {
    const rows = await db.all(`SELECT c.id, c.name, c.code, u.name as teacher_name, c.created_at,

-- Make target_user_id nullable for approval types that don't target a specific user
-- (e.g. class_creation, class_deletion, class_edit from schools)
...
INSERT INTO approval_requests_new
  (id, type, requester_type, requester_id, requester_name,
   ...
   class_id, report_id, school_id, title, description, proposed_grade, severity, metadata,

...
<template>
  <div class="guide-panel" v-if="visible">
    <div class="guide-header">
      <span class="guide-title">{{ t('experiments.genGuideTitle') }}</span>
    ...
    <div class="guide-body">
      ...
      <div class="step">
        ...
        <div class="step-text">
          {{ t('experiments.genGuideS10') }}
        </div>
      </div>

      <div class="formula-hint">
        <div class="formula">Φ = N · B · A · cos(ωt)</div>
        <div class="formula-desc">{{ t('experiments.genGuideF1') }}</div>
        <div class="formula" style="margin-top:.4rem">EMF = N·B·A·ω·sin(ωt)</div>
        <div class="formula-desc">{{ t('experiments.genGuideF2') }}</div>
        <div class="formula" style="margin-top:.4rem">EMF_peak = N·B·A·ω</div>
        <div class="formula-desc">{{ t('experiments.genGuideF3') }}</div>
        <div class="formula" style="margin-top:.4rem">f = ω / (2π)</div>
        <div class="formula-desc">{{ t('experiments.genGuideF4') }}</div>
        <div class="formula" style="margin-top:.4rem">I = EMF / R &nbsp;|&nbsp; P = EMF² / R</div>
        <div class="formula-desc">{{ t('experiments.genGuideF5') }}</div>
      </div>
    </div>
  </div>
</template>
...
.badge { background: rgba(34,197,94,.15); color: #22c55e; padding: .1rem .4rem; border-radius: 4px; font-size: .7rem; }
.badge.green { background: rgba(34,197,94,.15); color: #22c55e; }
.key { background: rgba(245,158,11,.12); color: #f59e0b; padding: .05rem .3rem; border-radius: 3px; font-size: .7rem; font-family: monospace; }

  ...
  <div class="guide-panel" v-if="visible">
    ...
    <div class="guide-body">
      ...
      <div class="step">
        ...
        <div class="step-text">
          {{ t('experiments.lfGuideS2Filament') }}
        </div>
      </div>
      ...
      <div class="step">
        ...
        <div class="step-text">
          {{ t('experiments.lfGuideS3Voltage') }}
        </div>
      </div>
      ...
      <div class="step">
        ...
        <div class="step-text">
          {{ t('experiments.lfGuideS5Observe') }}
        </div>
      </div>
      ...
      <div class="step">
        ...
        <div class="step-text">
          {{ t('experiments.lfGuideS8Measure') }}
        </div>
      </div>
      ...
      <div class="step">
        ...
        <div class="step-text">
          {{ t('experiments.lfGuideS10Analyze') }}
        </div>
      </div>

      <div class="formula-hint">
        <div class="formula">B = 8μ₀NI / (5√5 · R)</div>
        <div class="formula-desc">{{ t('experiments.lfGuideF1') }}</div>
        <div class="formula" style="margin-top:.4rem">v = √(2eV/m)</div>
        <div class="formula-desc">{{ t('experiments.lfGuideF2') }}</div>
        <div class="formula" style="margin-top:.4rem">r = mv / (eB)</div>
        <div class="formula-desc">{{ t('experiments.lfGuideF3') }}</div>
        <div class="formula" style="margin-top:.4rem">e/m = 2V / (B²r²)</div>
        <div class="formula-desc">{{ t('experiments.lfGuideF4') }}</div>
      </div>
    </div>
  </div>
</template>

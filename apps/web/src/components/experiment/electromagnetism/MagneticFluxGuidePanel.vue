...
<template>
  <div class="guide-panel" v-if="visible">
    <div class="guide-header">
      <span class="guide-title">{{ t('experiments.mfGuideTitle') }}</span>
    ...
    <div class="guide-body">
      ...
      <div class="step">
        ...
        <div class="step-text">
          {{ t('experiments.mfGuideS8') }}
        </div>
      </div>

      <div class="formula-hint">
        <div class="formula">Φ = B · A · cos(θ)</div>
        <div class="formula-desc">{{ t('experiments.mfGuideF1') }}</div>
        <div class="formula" style="margin-top:.4rem">Φ_max = B · A</div>
        <div class="formula-desc">{{ t('experiments.mfGuideF2') }}</div>
        <div class="formula" style="margin-top:.4rem">Φ = 0 at θ = 90°</div>
        <div class="formula-desc">{{ t('experiments.mfGuideF3') }}</div>
      </div>
    </div>
  </div>
</template>

...
.menu-right { display:flex; align-items:center; gap:.5rem; height:100%; }
.menu-center { font-size:1.05rem; font-weight:800; color:#22c55e; white-space:nowrap; pointer-events:none; padding:0 2rem; letter-spacing:.5px; }

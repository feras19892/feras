    ...
    <div v-if="open" class="overlay" @click.self="emit('close')">
      <div class="modal">
        <div class="modal-header">
          <h3>{{ t('experiments.ffHelpTitle') }}</h3>
        ...
        <div class="modal-body">
          ...
          <section>
            <h4>{{ t('experiments.ffHelpS1Title') }}</h4>
            <p>
              {{ t('experiments.ffHelpS1P1') }}
            </p>
            <p>
          ...
          <section>
            <h4>{{ t('experiments.ffHelpS2Title') }}</h4>
            <div class="method">{{ t('experiments.ffHelpS2M1') }}</div>
            <div class="method">{{ t('experiments.ffHelpS2M2') }}</div>
            <div class="method">{{ t('experiments.ffHelpS2M3') }}</div>
            <div class="method">{{ t('experiments.ffHelpS2M4') }}</div>
          </section>

          <!-- 3. Laboratory Procedure -->
          <section>
            <h4>{{ t('experiments.ffHelpS3Title') }}</h4>
            <ol>
              <li>{{ t('experiments.ffHelpS3L1') }}</li>
              <li>{{ t('experiments.ffHelpS3L2') }}</li>
              <li>{{ t('experiments.ffHelpS3L3') }}</li>
              <li>{{ t('experiments.ffHelpS3L4') }}</li>
              <li>{{ t('experiments.ffHelpS3L5') }}</li>
            </ol>
          </section>

          <!-- 4. Graphical Analysis -->
          <section>
            <h4>{{ t('experiments.ffHelpS4Title') }}</h4>
            <p>{{ t('experiments.ffHelpS4P1') }}</p>
            <ul>
          ...
          <section>
            <h4>{{ t('experiments.ffHelpS5Title') }}</h4>
            <div class="element-grid">
              <div class="element">
                {{ t('experiments.ffHelpS5E1') }}
              </div>
              <div class="element">
                {{ t('experiments.ffHelpS5E2') }}
              </div>
              <div class="element">
                {{ t('experiments.ffHelpS5E3') }}
              </div>
            </div>
          </section>
          ...
          <section>
            <h4>{{ t('experiments.ffHelpS6Title') }}</h4>
            <ul>
              <li>{{ t('experiments.ffHelpS6L1') }}</li>
              <li>{{ t('experiments.ffHelpS6L2') }}</li>
              <li>{{ t('experiments.ffHelpS6L3') }}</li>
            </ul>
          </section>

          <!-- Keyboard shortcuts (kept from existing) -->
          <section>
            <h4>{{ t('experiments.helpKbdTitle') }}</h4>
            <div class="kbd-grid">
              <span><kbd>Space</kbd> {{ t('experiments.ffHelpKbdSpace') }}</span>

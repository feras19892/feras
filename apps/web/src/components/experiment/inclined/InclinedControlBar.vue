...
<style scoped>
.control-bar { display:flex; align-items:center; gap:.4rem; padding:.4rem .6rem; background:linear-gradient(180deg,#1E2530,#161B22); border-top:1px solid #2D3645; flex-shrink:0; flex-wrap:wrap; }
...
.speed-control { display:flex; align-items:center; gap:.3rem; margin-right:auto; }

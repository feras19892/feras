...
<template>
  <nav class="menu-bar" ref="menuRef">
    <div class="menu-left">
      ...
      <div class="menu-group">
        ...
        <div v-if="activeMenu==='view'" class="menu-dropdown" @click.stop>
          ...
          <div class="menu-row check" @click="emit('togglePanel','scatter');"><span class="mi">&#x1F4C8;</span><span>{{ t('experiments.path') }}</span></div>
    ...
    <div class="menu-center">📐 {{ t('experiments.inclinedPlaneTitle') }}</div>

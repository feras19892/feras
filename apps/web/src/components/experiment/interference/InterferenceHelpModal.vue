    ...
    <div v-if="open" class="overlay" @click.self="emit('close')">
      <div class="modal">
        <div class="modal-header">
          <h3>{{ t('experiments.ifHelpTitle') }}</h3>
        ...
        <div class="modal-body">
          ...
          <section>
            <h4>{{ t('experiments.ifHelpS1Title') }}</h4>
            <ul>
              <li>{{ t('experiments.ifHelpS1L1') }}</li>
              <li>{{ t('experiments.ifHelpS1L2') }}</li>
              <li>{{ t('experiments.ifHelpS1L3') }}</li>
              <li>{{ t('experiments.ifHelpS1L4') }}</li>
              <li>{{ t('experiments.ifHelpS1L5') }}</li>
            </ul>
          </section>

          <!-- 2. Theoretical Background -->
          <section>
            <h4>{{ t('experiments.ifHelpS2Title') }}</h4>
            <p>{{ t('experiments.ifHelpS2P1') }}</p>
            <p>{{ t('experiments.ifHelpS2P2') }}</p>
            <ul>
              <li>{{ t('experiments.ifHelpS2L1') }}</li>
              <li>{{ t('experiments.ifHelpS2L2') }}</li>
            </ul>
          </section>
          ...
          <section>
            <h4>{{ t('experiments.ifHelpS4Title') }}</h4>
            <ol>
              <li>{{ t('experiments.ifHelpS4L1') }}</li>
              <li>{{ t('experiments.ifHelpS4L2') }}</li>
              <li>{{ t('experiments.ifHelpS4L3') }}</li>
              <li>{{ t('experiments.ifHelpS4L4') }}</li>
              <li>{{ t('experiments.ifHelpS4L5') }}</li>
            </ol>
          </section>

          <!-- 5. Graphical Analysis -->
          <section>
            <h4>{{ t('experiments.ifHelpS5Title') }}</h4>
            <p>{{ t('experiments.ifHelpS5P1') }}</p>
            <ul>
          ...
          <section>
            <h4>{{ t('experiments.ifHelpS6Title') }}</h4>
            <div class="element-grid">
              <div class="element">{{ t('experiments.ifHelpS6E1') }}</div>
              <div class="element">{{ t('experiments.ifHelpS6E2') }}</div>
              <div class="element">{{ t('experiments.ifHelpS6E3') }}</div>
            </div>
          </section>

          <!-- 7. Scientific Importance -->
          <section>
            <h4>{{ t('experiments.ifHelpS7Title') }}</h4>
            <ul>
              <li>{{ t('experiments.ifHelpS7L1') }}</li>
              <li>{{ t('experiments.ifHelpS7L2') }}</li>
              <li>{{ t('experiments.ifHelpS7L3') }}</li>
            </ul>
          </section>

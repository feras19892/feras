    ...
    <div v-if="open" class="overlay" @click.self="emit('close')">
      <div class="modal">
        <div class="modal-header">
          <h3>{{ t('experiments.lvHelpTitle') }}</h3>
        ...
        <div class="modal-body">
          ...
          <section>
            <h4>{{ t('experiments.lvHelpS2Title') }}</h4>
            <p>{{ t('experiments.lvHelpS2P1') }}</p>
            <div class="method">{{ t('experiments.lvHelpS2M1') }}</div>
            <div class="method">{{ t('experiments.lvHelpS2M2') }}</div>
            <div class="method">{{ t('experiments.lvHelpS2M3') }}</div>
            <div class="method">{{ t('experiments.lvHelpS2M4') }}</div>
            <div class="method">{{ t('experiments.lvHelpS2M5') }}</div>
          </section>

          <!-- 3. Laboratory Procedure -->
          <section>
            <h4>{{ t('experiments.lvHelpS3Title') }}</h4>
            <ol>
              <li>{{ t('experiments.lvHelpS3L1') }}</li>
              <li>{{ t('experiments.lvHelpS3L2') }}</li>
              <li>{{ t('experiments.lvHelpS3L3') }}</li>
              <li>{{ t('experiments.lvHelpS3L4') }}</li>
            </ol>
          </section>

          <!-- 4. Graphical Analysis -->
          <section>
            <h4>{{ t('experiments.lvHelpS4Title') }}</h4>
            <p>{{ t('experiments.lvHelpS4P1') }}</p>
            <ul>
          ...
          <section>
            <h4>{{ t('experiments.lvHelpS5Title') }}</h4>
            <div class="element-grid">
              <div class="element">{{ t('experiments.lvHelpS5E1') }}</div>
              <div class="element">{{ t('experiments.lvHelpS5E2') }}</div>
              <div class="element">{{ t('experiments.lvHelpS5E3') }}</div>
            </div>
          </section>

          <!-- 6. Scientific Importance -->
          <section>
            <h4>{{ t('experiments.lvHelpS6Title') }}</h4>
            <ul>
              <li>{{ t('experiments.lvHelpS6L1') }}</li>
              <li>{{ t('experiments.lvHelpS6L2') }}</li>
            </ul>
          </section>

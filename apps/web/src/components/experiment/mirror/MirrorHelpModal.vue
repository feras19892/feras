    ...
    <div v-if="open" class="overlay" @click.self="emit('close')">
      <div class="modal">
        <div class="modal-header">
          <h3>{{ t('experiments.miHelpTitle') }}</h3>
        ...
        <div class="modal-body">
          ...
          <section>
            <h4>{{ t('experiments.miHelpS1Title') }}</h4>
            <p>{{ t('experiments.miHelpS1P1') }}</p>
            <ul>
              <li>{{ t('experiments.miHelpS1L1') }}</li>
              <li>{{ t('experiments.miHelpS1L2') }}</li>
            </ul>
            <p>{{ t('experiments.miHelpS1P2') }}</p>
          </section>

          <!-- 2. Mathematical Equations -->
          <section>
            <h4>{{ t('experiments.miHelpS2Title') }}</h4>
            <p>{{ t('experiments.miHelpS2P1') }}</p>
            <div class="formula">1/f = 1/u + 1/v</div>
            <p>{{ t('experiments.miHelpS2P2') }}</p>
            <p>{{ t('experiments.miHelpS2P3') }}</p>
            <ul>
              <li>{{ t('experiments.miHelpS2L1') }}</li>
              <li>{{ t('experiments.miHelpS2L2') }}</li>
          ...
          <section>
            <h4>{{ t('experiments.miHelpS3Title') }}</h4>
            <p>{{ t('experiments.miHelpS3P1') }}</p>
            <ol>
              <li>{{ t('experiments.miHelpS3L1') }}</li>
              <li>{{ t('experiments.miHelpS3L2') }}</li>
              <li>{{ t('experiments.miHelpS3L3') }}</li>
              <li>{{ t('experiments.miHelpS3L4') }}</li>
              <li>{{ t('experiments.miHelpS3L5') }}</li>
            </ol>
          </section>

          <!-- 4. Graphical Analysis -->
          <section>
            <h4>{{ t('experiments.miHelpS4Title') }}</h4>
            <p>{{ t('experiments.miHelpS4P1') }}</p>
            <ul>
          ...
          <section>
            <h4>{{ t('experiments.miHelpS5Title') }}</h4>
            <div class="element-grid">
              <div class="element">{{ t('experiments.miHelpS5E1') }}</div>
              <div class="element">{{ t('experiments.miHelpS5E2') }}</div>
              <div class="element">{{ t('experiments.miHelpS5E3') }}</div>
            </div>
          </section>

          <!-- 6. Scientific Importance -->
          <section>
            <h4>{{ t('experiments.miHelpS6Title') }}</h4>
            <ul>
              <li>{{ t('experiments.miHelpS6L1') }}</li>
              <li>{{ t('experiments.miHelpS6L2') }}</li>
              <li>{{ t('experiments.miHelpS6L3') }}</li>
            </ul>
          </section>

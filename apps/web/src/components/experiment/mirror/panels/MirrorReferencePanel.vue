...
<template>
  <div class="panel-body">
    <div class="ref-title">📊 أنواع المرايا</div>
    <div class="ref-table">
      ...
      <div v-for="ref in MIRROR_TYPES" :key="ref.name" class="ref-row">
    ...
    <div class="ref-note">
      💡 للمرآة المقعرة: إذا do &gt; f → صورة حقيقية، إذا do &lt; f → صورة افتراضية.
    </div>
  </div>
</template>

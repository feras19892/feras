...
<template>
  <div class="ctrl-bar">
    <button class="ctrl-btn primary" @click="emit('togglePause')">
      {{ launchLabel }}<kbd>Space</kbd>
    </button>
    <button class="ctrl-btn record" @click="emit('recordTrial')">
      &#x1F4CC; {{ t('experiments.recordBtn') }}<kbd>S</kbd>
    </button>
    <div class="ctrl-sep" />

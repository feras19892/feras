    ...
    <div v-if="open" class="overlay" @click.self="emit('close')">
      <div class="modal">
        <div class="modal-header">
          <h3>{{ t('experiments.poHelpTitle') }}</h3>
        ...
        <div class="modal-body">
          ...
          <section>
            <h4>{{ t('experiments.poHelpS1Title') }}</h4>
            <ul>
              <li>{{ t('experiments.poHelpS1L1') }}</li>
              <li>{{ t('experiments.poHelpS1L2') }}</li>
              <li>{{ t('experiments.poHelpS1L3') }}</li>
              <li>{{ t('experiments.poHelpS1L4') }}</li>
              <li>{{ t('experiments.poHelpS1L5') }}</li>
            </ul>
          </section>

          <!-- 2. Theoretical Background -->
          <section>
            <h4>{{ t('experiments.poHelpS2Title') }}</h4>
            <p>{{ t('experiments.poHelpS2P1') }}</p>
            <p>{{ t('experiments.poHelpS2P2') }}</p>
            <ul>
              <li>{{ t('experiments.poHelpS2L1') }}</li>
              <li>{{ t('experiments.poHelpS2L2') }}</li>
            </ul>
            <p>{{ t('experiments.poHelpS2P3') }}</p>
          </section>
          ...
          <section>
            <h4>{{ t('experiments.poHelpS4Title') }}</h4>
            <ol>
              <li>{{ t('experiments.poHelpS4L1') }}</li>
              <li>{{ t('experiments.poHelpS4L2') }}</li>
              <li>{{ t('experiments.poHelpS4L3') }}</li>
              <li>{{ t('experiments.poHelpS4L4') }}</li>
              <li>{{ t('experiments.poHelpS4L5') }}</li>
            </ol>
          </section>

          <!-- 5. Graphical Analysis -->
          <section>
            <h4>{{ t('experiments.poHelpS5Title') }}</h4>
            <ul>
          ...
          <section>
            <h4>{{ t('experiments.poHelpS6Title') }}</h4>
            <div class="element-grid">
              <div class="element">{{ t('experiments.poHelpS6E1') }}</div>
              <div class="element">{{ t('experiments.poHelpS6E2') }}</div>
              <div class="element">{{ t('experiments.poHelpS6E3') }}</div>
            </div>
          </section>

          <!-- 7. Scientific Importance -->
          <section>
            <h4>{{ t('experiments.poHelpS7Title') }}</h4>
            <ul>
              <li>{{ t('experiments.poHelpS7L1') }}</li>
              <li>{{ t('experiments.poHelpS7L2') }}</li>
            </ul>
          </section>

    ...
    <div class="menu-left">
      ...
      <div class="menu-group">
        ...
        <div v-if="activeMenu==='view'" class="menu-dropdown" @click.stop>
          <div class="menu-row check" @click="emit('togglePanel','readings');"><span class="mi">&#x1F4CB;</span><span>القراءات</span></div>
          <div class="menu-row check" @click="emit('togglePanel','chart');"><span class="mi">&#x1F4C8;</span><span>الرسم البياني</span></div>
          <div class="menu-row check" @click="emit('togglePanel','trials');"><span class="mi">&#x1F4CA;</span><span>التجارب</span></div>
          <div class="menu-row check" @click="emit('togglePanel','params');"><span class="mi">&#x2699;&#xFE0F;</span><span>معاملات</span></div>
          <div class="menu-row check" @click="emit('togglePanel','laws');"><span class="mi">&#x2696;&#xFE0F;</span><span>القوانين</span></div>
          <div class="menu-row check" @click="emit('togglePanel','results');"><span class="mi">&#x1F4CB;</span><span>النتائج</span></div>
        </div>
      </div>
    </div>

    ...
    <div class="menu-left">
      ...
      <div class="menu-group">
        ...
        <div v-if="activeMenu==='view'" class="menu-dropdown" @click.stop>
          ...
          <div class="menu-row check" @click="emit('togglePanel','signal');"><span class="mi">&#x1F4C8;</span><span>مسار y(x)</span></div>
          <div class="menu-row check" @click="emit('togglePanel','vxSignal');"><span class="mi">&#x1F4C8;</span><span>vₓ(t)</span></div>
          <div class="menu-row check" @click="emit('togglePanel','vySignal');"><span class="mi">&#x1F4C8;</span><span>vᵧ(t)</span></div>
    ...
    <div class="menu-right">
      ...
      <div class="menu-group">
        ...
        <div v-if="activeMenu==='run'" class="menu-dropdown" @click.stop>
          ...
          <div class="menu-sep" />
          <div class="menu-row" @click="emit('runLab'); closeMenu()"><span class="mi">&#x26A1;</span><span>تشغيل تلقائي</span></div>
        </div>
      </div>
      <div class="menu-group">

    ...
    <div class="menu-left">
      ...
      <div class="menu-group">
        ...
        <div v-if="activeMenu==='view'" class="menu-dropdown" @click.stop>
          ...
          <div class="menu-row check" @click="emit('togglePanel','signal');"><span class="mi">&#x1F4C8;</span><span>{{ t('experiments.menuPathYx') }}</span></div>
          <div class="menu-row check" @click="emit('togglePanel','vxSignal');"><span class="mi">&#x1F4C8;</span><span>{{ t('experiments.menuVxT') }}</span></div>
          <div class="menu-row check" @click="emit('togglePanel','vySignal');"><span class="mi">&#x1F4C8;</span><span>{{ t('experiments.menuVyT') }}</span></div>

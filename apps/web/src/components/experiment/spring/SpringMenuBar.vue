    ...
    <div class="menu-left">
      ...
      <div class="menu-group">
        ...
        <div v-if="activeMenu==='view'" class="menu-dropdown" @click.stop>
          ...
          <div class="menu-row check" @click="emit('togglePanel','static');"><span class="mi">&#x1F4D0;</span><span>إستاتيكي</span></div>
          <div class="menu-row check" @click="emit('togglePanel','error');"><span class="mi">&#x2696;&#xFE0F;</span><span>أخطاء</span></div>
        </div>
      </div>
    </div>
    <div class="menu-center">&#x1F9EA; تجربة النابض المتقدمة</div>
    <div class="menu-right">
      <div class="menu-group">
        <button class="menu-btn" @click="router.push('/physics/mechanics/spring')">&#x1F9EA; Basic Spring</button>
      </div>
      <div class="menu-group">

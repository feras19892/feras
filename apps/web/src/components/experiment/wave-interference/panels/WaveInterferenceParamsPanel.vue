...
<template>
  <div class="panel-body">
    <div class="param-row">
      <div class="param-header"><span class="param-label">{{ t('experiments.wiSourceDistance') }}</span><span class="param-val cyan">{{ params.sourceDistance.toFixed(3) }} m</span></div>
    ...
    <div class="param-row">
      <div class="param-header"><span class="param-label">{{ t('experiments.wiWavelength') }}</span><span class="param-val amber">{{ (params.wavelength * 1000).toFixed(1) }} mm</span></div>
    ...
    <div class="param-row">
      <div class="param-header"><span class="param-label">{{ t('experiments.wiFrequency') }}</span><span class="param-val green">{{ params.frequency }} Hz</span></div>
    ...
    <div class="param-row">
      <div class="param-header"><span class="param-label">{{ t('experiments.wiScreenDistance') }}</span><span class="param-val">{{ params.screenDistance.toFixed(2) }} m</span></div>

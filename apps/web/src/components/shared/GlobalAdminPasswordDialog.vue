...
const { dialogVisible, dialogOptions, dialogPassword, acceptDialog, cancelDialog } = useAdminPasswordConfirm()
      ...
      <div v-if="dialogVisible" class="dialog-overlay" @click.self="cancelDialog">
        <div class="dialog-modal">
          ...
          <input
            ...
            type="password"
            class="dialog-input"
            :placeholder="t('account.currentPassword', 'كلمة مرور الإدمن')"
          ...
          <div class="dialog-actions">
            ...
            <button :class="['dialog-btn', dialogOptions.variant || 'danger']" @click="acceptDialog">
...
.dialog-input {
  ...
  color: #e2e8f0; font-family: inherit; box-sizing: border-box;
}
.dialog-actions {
  display: flex; gap: 0.6rem; justify-content: center; margin-top: 0.5rem;
}
.dialog-btn {

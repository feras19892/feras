...
import { useAnimalCellGLB } from '../../../composables/biology/useAnimalCellGLB';
import type { AnimalCellPart } from '../../../composables/biology/useAnimalCellGLB';
...
const {
  ...
  resetAll,
  selectPartById,
} = useAnimalCellGLB(containerRef, props.parts);
...
const partList = computed<{ id: string; label: string }[]>(() =>
  props.parts.map((p) => ({ id: p.id, label: t(p.nameKey) }))
);

const activePart = computed<AnimalCellPart | null>(() => {
...
<template>
  <div class="experiment-page">
    <header class="top-bar">
      ...
      <h1 class="title">{{ t('biology.animalCellTitle') }}</h1>
    </header>
    ...
    <main class="main-layout">
      <aside class="left-panel">
        <div class="controls-card">
          ...
          <div class="controls-grid">
            ...
            >
              {{ insideView ? t('biology.animalCellExitInsideView') : t('biology.animalCellInsideView') }}
            </button>
          </div>
      ...
      <aside class="right-panel">
        <div v-if="partList.length" class="parts-card">
          <h2 class="panel-title">{{ t('biology.animalCellPartsListTitle') }}</h2>
          <ul class="parts-list">
            <li

...
<template>
  <div class="polarization-lab">
    ...
    <PolarizationHelpModal :open="helpOpen" @close="helpOpen = false" />
    ...
    <div class="lab-grid">
        ...
        <template v-for="id in ex.layout.columnMap.data" :key="id">
          ...
          >
            <PolarizationPanelBody
              ...
              :params="ex.params"
              :output-intensity="ex.lab.outputIntensity.value"
              :relative-angle="ex.lab.relativeAngle.value"
              :transmission-percent="ex.lab.transmissionPercent.value"
              :intensity-curve="ex.lab.intensityCurve.value"
              ...
              :i0-from-regression="ex.lab.i0FromRegression.value"
      ...
      <div class="lab-col vis-col">
        <div class="vis-canvas-wrap">
          <PolarizationCanvas
            :polarizer-angle="ex.params.polarizerAngle"
            :analyzer-angle="ex.params.analyzerAngle"
            :input-intensity="ex.params.I0"
            :output-intensity="ex.lab.outputIntensity.value"
            :running="ex.lab.running.value"
          />
        </div>
        <PolarizationControlBar
...
<style scoped>
.polarization-lab { background: #161B22; color: #D1D7E0; padding: .6rem .8rem; height: 100vh; display: flex; flex-direction: column; gap: .5rem; overflow: hidden; }

...
const stats = computed(() => [
  { value: store.totalClasses, label: 'الفصول' },
  { value: store.reports.length, label: 'التقارير' },
  { value: store.pendingReports.length, label: 'المعلّق' },
...
.avatar { width: 64px; height: 64px; border-radius: 50%; background: #6366f1; display: flex; align-items: center; justify-content: center; cursor: pointer; overflow: hidden; font-size: 24px; }

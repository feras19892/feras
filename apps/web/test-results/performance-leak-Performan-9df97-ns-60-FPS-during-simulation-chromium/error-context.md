...
- Name: performance-leak.spec.ts >> Performance & Memory Leak >> collision experiment maintains 60 FPS during simulation
- Location: tests\performance-leak.spec.ts:4:3
